...
* Clustering.ipynb has some very initial efforts trying to cluster the data using KMeans in hopes of creating additional features.  Clustered by game and by team.
* Analysis_with_catagorical_targets.ipynb bins spread into boolean and decile categories for prediction of outcomes.
